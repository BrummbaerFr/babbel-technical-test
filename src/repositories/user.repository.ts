...
class UserRepository {
	...
	public async createAccount(firstName: string, lastName: string, username: string, password: string) {
	...
	public async updateAccount(id: number, firstName: string, lastName: string, username: string, password: string) {
